 ...
 * @Description:
 * @Author: LongRou
 * @CreateDate: 2018 2018/5/31 15:02
 * @Version: 1.0
 **/
public class ScreenUtil {
    ...
    private static int getInternalDimensionSize(Resources res) {
        int result = 0;
        int resourceId = res.getIdentifier(ScreenUtil.STATUS_BAR_HEIGHT_RES_NAME, "dimen", "android");
        if (resourceId > 0) {
